...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/order/save-order" method="post" id="orders" novalidate>
            <div class="row">
                <!-- Billing Address -->
                <div class="col-md-6">
                    <div class="card">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card shadow mt-3">
                        <div class="card-body">
                            ...
                            <button type="button" id="razorpay-button" class="btn btn-primary" style="display:none;">Pay with Razorpay</button>
